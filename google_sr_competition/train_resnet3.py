...
def run_train():
    ...
    out_dir  = '/root/share/project/kaggle/tensorflow/results/se-resnet3-spect-02' # s_xx1'
    initial_checkpoint = \
        None #'/root/share/project/kaggle/tensorflow/results/se-resnet3-spect-02/checkpoint/00010000_model.pth'
